...
* Use the `GTEx_FE_META_TISSUE_GE_MaxCPP` annotation
* Conditional on baselineLD v1.1

```{bash, eval=FALSE}
cd /project2/xinhe/kevinluo/ldsc/results/sLDSC_Hormozdiari_NG2018/LDSC_QTL/logs/

TRAITS=("PASS_Autism" "PASS_BMI1" "PASS_Rheumatoid_Arthritis" "PASS_Schizophrenia" "UKB_460K.blood_WHITE_COUNT" "UKB_460K.blood_PLATELET_COUNT")
...
dir_results <- paste0("/project2/xinhe/kevinluo/ldsc/results/sLDSC_Hormozdiari_NG2018/LDSC_QTL/results/")

trait_name_list <- c("PASS_Autism", "PASS_BMI1", "PASS_Rheumatoid_Arthritis", "PASS_Schizophrenia", "UKB_460K.blood_WHITE_COUNT", "UKB_460K.blood_PLATELET_COUNT")
